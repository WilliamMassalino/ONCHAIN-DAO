...
import "../lib/foundry-app/src/CryptoDevs.sol";
...
contract CryptoDevsDAO is Ownable {
    ...
    struct Proposal {
        ...
        bool executed;
        // voters - a mapping of CryptoDevsNFT holders address to booleans indicating whether that a NFT holder has already voted or not
        ...
        activeProposalOnly(proposalIndex)
    {
        ...
        // Verify if a user has already voted in this proposal
        require(proposal.voters[msg.sender] == false, "ALREADY_VOTED");

        // Checks that this address has already voted
        proposal.voters[msg.sender] = true;
        // Increases the number of votes, regardless of the number of NFTs
